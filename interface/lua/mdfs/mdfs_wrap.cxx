...
static int _proxy__wrap_new_mdfsException(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_mdfsException);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_mdfsException_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_mdfsException_methods[]= {
    {0,0}
};
static swig_lua_method swig_mdfsException_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_mdfsException_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_mdfsException_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_mdfsException_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_mdfsException_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_mdfsException_Sf_SwigStatic = {
    "mdfsException",
    swig_mdfsException_Sf_SwigStatic_methods,
    swig_mdfsException_Sf_SwigStatic_attributes,
    swig_mdfsException_Sf_SwigStatic_constants,
    swig_mdfsException_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_mdfsException_bases[] = {0};
static const char *swig_mdfsException_base_names[] = {0};
static swig_lua_class _wrap_class_mdfsException = { "mdfsException", "mdfsException", &SWIGTYPE_p_Madoop__mdfsException,_proxy__wrap_new_mdfsException, swig_delete_mdfsException, swig_mdfsException_methods, swig_mdfsException_attributes, &swig_mdfsException_Sf_SwigStatic, swig_mdfsException_meta, swig_mdfsException_bases, swig_mdfsException_base_names };
...
static int _proxy__wrap_new_mdfsFile(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_mdfsFile);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_mdfsFile_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_mdfsFile_methods[]= {
    { "write", _wrap_mdfsFile_write},
    { "append", _wrap_mdfsFile_append},
    { "read", _wrap_mdfsFile_read},
    {0,0}
};
static swig_lua_method swig_mdfsFile_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_mdfsFile_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_mdfsFile_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_mdfsFile_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_mdfsFile_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_mdfsFile_Sf_SwigStatic = {
    "mdfsFile",
    swig_mdfsFile_Sf_SwigStatic_methods,
    swig_mdfsFile_Sf_SwigStatic_attributes,
    swig_mdfsFile_Sf_SwigStatic_constants,
    swig_mdfsFile_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_mdfsFile_bases[] = {0};
static const char *swig_mdfsFile_base_names[] = {0};
static swig_lua_class _wrap_class_mdfsFile = { "mdfsFile", "mdfsFile", &SWIGTYPE_p_Madoop__mdfsFile,_proxy__wrap_new_mdfsFile, swig_delete_mdfsFile, swig_mdfsFile_methods, swig_mdfsFile_attributes, &swig_mdfsFile_Sf_SwigStatic, swig_mdfsFile_meta, swig_mdfsFile_bases, swig_mdfsFile_base_names };
...
static int _proxy__wrap_new_mdfsDir(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_mdfsDir);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_mdfsDir_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_mdfsDir_methods[]= {
    {0,0}
};
static swig_lua_method swig_mdfsDir_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_mdfsDir_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_mdfsDir_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_mdfsDir_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_mdfsDir_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_mdfsDir_Sf_SwigStatic = {
    "mdfsDir",
    swig_mdfsDir_Sf_SwigStatic_methods,
    swig_mdfsDir_Sf_SwigStatic_attributes,
    swig_mdfsDir_Sf_SwigStatic_constants,
    swig_mdfsDir_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_mdfsDir_bases[] = {0};
static const char *swig_mdfsDir_base_names[] = {0};
static swig_lua_class _wrap_class_mdfsDir = { "mdfsDir", "mdfsDir", &SWIGTYPE_p_Madoop__mdfsDir,_proxy__wrap_new_mdfsDir, swig_delete_mdfsDir, swig_mdfsDir_methods, swig_mdfsDir_attributes, &swig_mdfsDir_Sf_SwigStatic, swig_mdfsDir_meta, swig_mdfsDir_bases, swig_mdfsDir_base_names };
...
static int _proxy__wrap_new_mdfsFS(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_mdfsFS);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_mdfsFS_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_mdfsFS_methods[]= {
    {0,0}
};
static swig_lua_method swig_mdfsFS_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_mdfsFS_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_mdfsFS_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_mdfsFS_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_mdfsFS_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_mdfsFS_Sf_SwigStatic = {
    "mdfsFS",
    swig_mdfsFS_Sf_SwigStatic_methods,
    swig_mdfsFS_Sf_SwigStatic_attributes,
    swig_mdfsFS_Sf_SwigStatic_constants,
    swig_mdfsFS_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_mdfsFS_bases[] = {0};
static const char *swig_mdfsFS_base_names[] = {0};
static swig_lua_class _wrap_class_mdfsFS = { "mdfsFS", "mdfsFS", &SWIGTYPE_p_Madoop__mdfsFS,_proxy__wrap_new_mdfsFS, swig_delete_mdfsFS, swig_mdfsFS_methods, swig_mdfsFS_attributes, &swig_mdfsFS_Sf_SwigStatic, swig_mdfsFS_meta, swig_mdfsFS_bases, swig_mdfsFS_base_names };
...
&_wrap_class_mdfsException,
&_wrap_class_mdfsFile,
&_wrap_class_mdfsDir,
&_wrap_class_mdfsFS,
    0
};
...
static swig_type_info _swigt__p_Madoop__mdfsDir = {"_p_Madoop__mdfsDir", "Madoop::mdfsDir *", 0, 0, (void*)&_wrap_class_mdfsDir, 0};
static swig_type_info _swigt__p_Madoop__mdfsException = {"_p_Madoop__mdfsException", "Madoop::mdfsException *", 0, 0, (void*)&_wrap_class_mdfsException, 0};
static swig_type_info _swigt__p_Madoop__mdfsFS = {"_p_Madoop__mdfsFS", "Madoop::mdfsFS *", 0, 0, (void*)&_wrap_class_mdfsFS, 0};
static swig_type_info _swigt__p_Madoop__mdfsFile = {"_p_Madoop__mdfsFile", "Madoop::mdfsFile *", 0, 0, (void*)&_wrap_class_mdfsFile, 0};
