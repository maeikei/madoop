...
SWIGEXPORT void JNICALL Java_mdfsJNI_Madoop_1set(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  namespace arg1 ;
  namespace *argp1 ;
...
SWIGEXPORT jlong JNICALL Java_mdfsJNI_Madoop_1get(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  namespace result;
