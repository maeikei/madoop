...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoop_set, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoop_get, 0, 0, 0)
ZEND_END_ARG_INFO()
...
static zend_function_entry mdfs_functions[] = {
 SWIG_ZEND_NAMED_FE(madoop_set,_wrap_Madoop_set,swig_arginfo_madoop_set)
 SWIG_ZEND_NAMED_FE(madoop_get,_wrap_Madoop_get,swig_arginfo_madoop_get)
