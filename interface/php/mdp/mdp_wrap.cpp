...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_madoopjobcontext, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoopjobcontext_textfile, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoopjobcontext_imagefile, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoopjobcontext_videofile, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_madoopjobcontext_audiofile, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_mdpobject_write, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_textline, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_textlinefilter, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_textlinefilter_c_empty, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_textword, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_textwordfilter, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_textwordfilter_c_empty, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_new_textfile, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_mc_set, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_mc_get, 0, 0, 0)
ZEND_END_ARG_INFO()
...
static zend_function_entry mdp_functions[] = {
 SWIG_ZEND_NAMED_FE(new_madoopjobcontext,_wrap_new_MadoopJobContext,swig_arginfo_new_madoopjobcontext)
 SWIG_ZEND_NAMED_FE(madoopjobcontext_textfile,_wrap_MadoopJobContext_textFile,swig_arginfo_madoopjobcontext_textfile)
 SWIG_ZEND_NAMED_FE(madoopjobcontext_imagefile,_wrap_MadoopJobContext_imageFile,swig_arginfo_madoopjobcontext_imagefile)
 SWIG_ZEND_NAMED_FE(madoopjobcontext_videofile,_wrap_MadoopJobContext_videoFile,swig_arginfo_madoopjobcontext_videofile)
 SWIG_ZEND_NAMED_FE(madoopjobcontext_audiofile,_wrap_MadoopJobContext_audioFile,swig_arginfo_madoopjobcontext_audiofile)
 SWIG_ZEND_NAMED_FE(mdpobject_write,_wrap_MdpObject_write,swig_arginfo_mdpobject_write)
 SWIG_ZEND_NAMED_FE(new_textline,_wrap_new_TextLine,swig_arginfo_new_textline)
 SWIG_ZEND_NAMED_FE(new_textlinefilter,_wrap_new_TextLineFilter,swig_arginfo_new_textlinefilter)
 SWIG_ZEND_NAMED_FE(textlinefilter_c_empty,_wrap_TextLineFilter_c_empty,swig_arginfo_textlinefilter_c_empty)
 SWIG_ZEND_NAMED_FE(new_textword,_wrap_new_TextWord,swig_arginfo_new_textword)
 SWIG_ZEND_NAMED_FE(new_textwordfilter,_wrap_new_TextWordFilter,swig_arginfo_new_textwordfilter)
 SWIG_ZEND_NAMED_FE(textwordfilter_c_empty,_wrap_TextWordFilter_c_empty,swig_arginfo_textwordfilter_c_empty)
 SWIG_ZEND_NAMED_FE(new_textfile,_wrap_new_TextFile,swig_arginfo_new_textfile)
 SWIG_ZEND_NAMED_FE(mc_set,_wrap_mc_set,swig_arginfo_mc_set)
 SWIG_ZEND_NAMED_FE(mc_get,_wrap_mc_get,swig_arginfo_mc_get)
